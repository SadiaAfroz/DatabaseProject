...
public class HRexecutive extends Application {
        String  hrmanid;
            Stage stage;
   
         
       public HRexecutive(String hrmanid) {
    ...
    stage=primaryStage;
        ...
        Text guestwintext = new Text("    HR Executive Account");
    ...
    +"-fx-background-color: linear-gradient(#61a2b1, #2A5058);"
     +"-fx-effect: dropshadow( three-pass-box , rgba(0,0,0,0.6) , 5, 0.0 , 0 , 1 );"
        ...
        discbtn.setOnMouseEntered(e -> {
          ...
          Button addpart = new Button("Add Parttime Job Holder");
    ...
    +"-fx-background-color: linear-gradient(#61a2b1, #2A5058);"
     +"-fx-effect: dropshadow( three-pass-box , rgba(0,0,0,0.6) , 5, 0.0 , 0 , 1 );"
        ...
        VBox guest5 = new VBox(50);
        addpart.setPrefSize(200, 35);
        guest5.setAlignment(Pos.CENTER);
        guest5.getChildren().add(addpart);
        grid5.add(guest5, 0, 8);
        
        addpart.setOnMouseEntered(e -> {
            addpart.setCursor(Cursor.HAND);
        });
...
*/
    ...
    +"-fx-background-color: linear-gradient(#61a2b1, #2A5058);"
     +"-fx-effect: dropshadow( three-pass-box , rgba(0,0,0,0.6) , 5, 0.0 , 0 , 1 );"
        ...
        GridPane gridaddpart = new GridPane();
        gridaddpart.setStyle("-fx-background-color: silver;");
        gridaddpart.setHgap(30);
        gridaddpart.setVgap(20);

        gridaddpart.setAlignment(Pos.CENTER);

        Scene adddiscountwindow = new Scene(gridaddpart, 600, 500);
       ...
       Text label13 = new Text("MEMBER ID");
        ...
        pr53[0] = new VBox();
            ...
            pr53[0].getChildren().add(p53[0]);
                ...
                gridaddpart.add(pr13[0], 1, 1);
        gridaddpart.add(pr23[0], 1, 2);
                gridaddpart.add(pr33[0], 1, 3);
                gridaddpart.add(pr43[0], 1, 4);
     gridaddpart.add(pr53[0], 1, 5);


        
        
            Button partadd=new Button("ADD");
            partadd.setPrefSize(150, 35);
    ...
    +"-fx-background-color: linear-gradient(#61a2b1, #2A5058);"
     +"-fx-effect: dropshadow( three-pass-box , rgba(0,0,0,0.6) , 5, 0.0 , 0 , 1 );"
             ...
             gridaddpart.add(partadd, 1, 6);
             
            partadd.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
             ...
             //insertdiscount(p13[0].getText(),p23[0].getText(),p33[0].getText(),p43[0].getText(),p53[0].getText());
              ...
              Button backfrompart=new Button("BACK");
            backfrompart.setPrefSize(150, 35);
            
             backfrompart.setStyle(
    "-fx-text-fill: white;"
            + "-fx-font-size: 12pt; "
    +"-fx-font-family: \"Arial Narrow\";"
    +"-fx-font-weight: bold;"
    +"-fx-background-color: linear-gradient(#61a2b1, #2A5058);"
     +"-fx-effect: dropshadow( three-pass-box , rgba(0,0,0,0.6) , 5, 0.0 , 0 , 1 );"
             ...
             gridaddpart.add(backfrompart, 1, 7);
             
                 backfrompart.setOnAction((event) -> {
            stage.setScene(openwindow);
        });
